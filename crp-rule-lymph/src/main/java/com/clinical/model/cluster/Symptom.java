...
public class Symptom{
    ...
    //l淋巴瘤症状
    private String lymphCancerName;
    //心力衰竭症状
    ...
    public String getLymphCancerName(){
        return lymphCancerName;
    } 
    public void setLymphCancerName(String lymphCancerName) {
         this.lymphCancerName = lymphCancerName;
    } 
