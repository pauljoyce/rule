...
public class HisPast{
    ...
    public String getBreastDiseases(){
        return breastDiseases;
    } 
    public void setBreastDiseases(String breastDiseases) {
         this.breastDiseases = breastDiseases;
    } 
