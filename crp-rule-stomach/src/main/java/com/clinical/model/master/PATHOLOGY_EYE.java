...
public class PATHOLOGY_EYE{
    ...
    //肿物形态1
    private String lesion_shape1_std;
    //病变1
    private String lesion1_std;
    //肿物形态2
    private String lesion_shape2_std;
    //病变2
    private String lesion2_std;
    //大小-最大径1
    private String size_max_diam1_std;
    //大小-中间径1
    private String size_median_diam1_std;
    //大小-最小径1
    private String size_min_diam1_std;
    //大小-单位1
    private String size_unit1_std;
    //大小-最大径2
    private String size_max_diam2_std;
    //大小-中间径2
    private String size_median_diam2_std;
    //大小-最小径2
    private String size_min_diam2_std;
    //大小-单位2
    private String size_unit2_std;
    //大小-最大径3
    private String size_max_diam3_std;
    //大小-中间径3
    private String size_median_diam3_std;
    //大小-最小径3
    private String size_min_diam3_std;
    //大小-单位3
    private String size_unit3_std;
    //切缘距离-距切缘1
    private String edge_distance1_std;
    //切缘距离-距切缘2
    private String edge_distance2_std;
    //切缘距离-单位
    private String edge_distance_unit_std;
    //数量-标准名称
    ...
    public void setedge_distance(String edge_distance) {
    ...
    public String getlesion_shape1_std(){
        return lesion_shape1_std;
    } 
    public void setlesion_shape1_std(String lesion_shape1_std) {
         this.lesion_shape1_std = lesion_shape1_std;
    } 
    ...
    public String getlesion_shape2_std(){
        return lesion_shape2_std;
    } 
    public void setlesion_shape2_std(String lesion_shape2_std) {
         this.lesion_shape2_std = lesion_shape2_std;
    } 
    ...
    public String getsize_max_diam1_std(){
        return size_max_diam1_std;
    } 
    public void setsize_max_diam1_std(String size_max_diam1_std) {
         this.size_max_diam1_std = size_max_diam1_std;
    } 
    public String getsize_median_diam1_std(){
        return size_median_diam1_std;
    } 
    public void setsize_median_diam1_std(String size_median_diam1_std) {
         this.size_median_diam1_std = size_median_diam1_std;
    } 
    public String getsize_min_diam1_std(){
        return size_min_diam1_std;
    } 
    public void setsize_min_diam1_std(String size_min_diam1_std) {
    ...
    public String getsize_max_diam2_std(){
        return size_max_diam2_std;
    } 
    public void setsize_max_diam2_std(String size_max_diam2_std) {
         this.size_max_diam2_std = size_max_diam2_std;
    } 
    public String getsize_median_diam2_std(){
        return size_median_diam2_std;
    } 
    public void setsize_median_diam2_std(String size_median_diam2_std) {
         this.size_median_diam2_std = size_median_diam2_std;
    } 
    public String getsize_min_diam2_std(){
        return size_min_diam2_std;
    } 
    public void setsize_min_diam2_std(String size_min_diam2_std) {
    ...
    public String getsize_max_diam3_std(){
        return size_max_diam3_std;
    } 
    public void setsize_max_diam3_std(String size_max_diam3_std) {
         this.size_max_diam3_std = size_max_diam3_std;
    } 
    public String getsize_median_diam3_std(){
        return size_median_diam3_std;
    } 
    public void setsize_median_diam3_std(String size_median_diam3_std) {
         this.size_median_diam3_std = size_median_diam3_std;
    } 
    public String getsize_min_diam3_std(){
        return size_min_diam3_std;
    } 
    public void setsize_min_diam3_std(String size_min_diam3_std) {
    ...
    public String getedge_distance1_std(){
        return edge_distance1_std;
    } 
    public void setedge_distance1_std(String edge_distance1_std) {
         this.edge_distance1_std = edge_distance1_std;
    } 
    public String getedge_distance2_std(){
        return edge_distance2_std;
    } 
    public void setedge_distance2_std(String edge_distance2_std) {
         this.edge_distance2_std = edge_distance2_std;
    } 
    public String getedge_distance_unit_std(){
        return edge_distance_unit_std;
    } 
    public void setedge_distance_unit_std(String edge_distance_unit_std) {
         this.edge_distance_unit_std = edge_distance_unit_std;
    } 
