...
public class TRANSFUSION_HISTORY{
    //流水号
    ...
    //是否有输血史
    private String WHETHER_TRANSFUSION;
    //输血成分
    ...
    //标准化是否有输血史
    private String WHETHER_TRANSFUSION_STD;
    //标准化输血成分
    private String BLOOD_COMPONENT_STD;
    //标准化输血血型
    private String BLOOD_TYPE_STD;
    //标准化是否出现输血反应
    ...
    public String getWHETHER_TRANSFUSION(){
        return WHETHER_TRANSFUSION;
    } 
    public void setWHETHER_TRANSFUSION(String WHETHER_TRANSFUSION) {
         this.WHETHER_TRANSFUSION = WHETHER_TRANSFUSION;
    } 
    ...
    public String getWHETHER_TRANSFUSION_STD(){
        return WHETHER_TRANSFUSION_STD;
    } 
    public void setWHETHER_TRANSFUSION_STD(String WHETHER_TRANSFUSION_STD) {
         this.WHETHER_TRANSFUSION_STD = WHETHER_TRANSFUSION_STD;
    } 
    public String getBLOOD_COMPONENT_STD(){
        return BLOOD_COMPONENT_STD;
    } 
    public void setBLOOD_COMPONENT_STD(String BLOOD_COMPONENT_STD) {
         this.BLOOD_COMPONENT_STD = BLOOD_COMPONENT_STD;
    } 
    public String getBLOOD_TYPE_STD(){
        return BLOOD_TYPE_STD;
    } 
    public void setBLOOD_TYPE_STD(String BLOOD_TYPE_STD) {
         this.BLOOD_TYPE_STD = BLOOD_TYPE_STD;
    } 
