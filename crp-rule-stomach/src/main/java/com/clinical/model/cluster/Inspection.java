...
public class Inspection{
    ...
    //检验项目名称标化
    private String testItemNameStd;
    //数据版本
    ...
    public String getTestItemNameStd(){
        return testItemNameStd;
    } 
    public void setTestItemNameStd(String testItemNameStd) {
         this.testItemNameStd = testItemNameStd;
    } 
