...
public class ExamDescription{
    ...
    public String getFindSite(){
        return findSite;
    } 
    public void setFindSite(String findSite) {
    ...
    public String getFindBirads(){
        return findBirads;
    } 
    public void setFindBirads(String findBirads) {
         this.findBirads = findBirads;
    } 
