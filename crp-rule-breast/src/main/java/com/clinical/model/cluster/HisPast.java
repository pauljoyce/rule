...
public class HisPast{
    ...
    //其它乳腺良性疾病
    private String otherBreastDiseases;
    //风湿免疫系统疾病
    private String rheumaticDiseases;
    //曾有精神创伤史
    ...
    public String getOtherBreastDiseases(){
        return otherBreastDiseases;
    } 
    public void setOtherBreastDiseases(String otherBreastDiseases) {
         this.otherBreastDiseases = otherBreastDiseases;
    } 
    public String getRheumaticDiseases(){
        return rheumaticDiseases;
    } 
    public void setRheumaticDiseases(String rheumaticDiseases) {
