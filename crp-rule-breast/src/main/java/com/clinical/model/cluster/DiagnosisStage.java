...
public class DiagnosisStage{
    ...
    //TNM分期所属诊断名称
    private String diagnosisStageName;
    //T分期
    ...
    public String getDiagnosisStageName(){
        return diagnosisStageName;
    } 
    public void setDiagnosisStageName(String diagnosisStageName) {
         this.diagnosisStageName = diagnosisStageName;
    } 
