...
public class BREAST_US_ENTRY_RESULTS{
    //顺序流水号
    ...
    public String getscale_modify(){
        return scale_modify;
    } 
    public void setscale_modify(String scale_modify) {
         this.scale_modify = scale_modify;
    } 
