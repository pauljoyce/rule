...
public class PRIOR_DISEASE_AND_SURGERY{
    ...
    //合并疾病名称标准名称id
    private String diag_name_std;
    //手术名称标准名称id
    private String surgery_name_std;
    ...
    public String getdiag_name_std(){
        return diag_name_std;
    } 
    public void setdiag_name_std(String diag_name_std) {
         this.diag_name_std = diag_name_std;
    } 
    public String getsurgery_name_std(){
        return surgery_name_std;
    } 
    public void setsurgery_name_std(String surgery_name_std) {
         this.surgery_name_std = surgery_name_std;
    } 
}