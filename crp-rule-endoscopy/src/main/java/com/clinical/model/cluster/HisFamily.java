...
public class HisFamily{
    ...
    //肠息肉家族史
    private String intestinalPolyps;
    //肠炎家族史
    private String enteritis;
    //消化道疾病家族史
    ...
    public String getIntestinalPolyps(){
        return intestinalPolyps;
    } 
    public void setIntestinalPolyps(String intestinalPolyps) {
         this.intestinalPolyps = intestinalPolyps;
    } 
    public String getEnteritis(){
        return enteritis;
    } 
    public void setEnteritis(String enteritis) {
         this.enteritis = enteritis;
    } 
