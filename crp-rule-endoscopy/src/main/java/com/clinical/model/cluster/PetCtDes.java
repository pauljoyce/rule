...
public class PetCtDes{
    ...
    //原发肿物数目
    private String primaryQuantityStd;
    //原发肿物大小
    private String primarySizeStd;
    //转移灶数目
    ...
    public String getPrimaryQuantityStd(){
        return primaryQuantityStd;
    } 
    public void setPrimaryQuantityStd(String primaryQuantityStd) {
         this.primaryQuantityStd = primaryQuantityStd;
    } 
    public String getPrimarySizeStd(){
        return primarySizeStd;
    } 
    public void setPrimarySizeStd(String primarySizeStd) {
         this.primarySizeStd = primarySizeStd;
    } 
