...
public class HisPerson{
    ...
    public String getStopSmokeYear(){
        return stopSmokeYear;
    } 
    public void setStopSmokeYear(String stopSmokeYear) {
    ...
    public String getStopDrinkYear(){
        return stopDrinkYear;
    } 
    public void setStopDrinkYear(String stopDrinkYear) {
