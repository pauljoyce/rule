...
public class Gastroscope{
    ...
    //病灶上缘距门齿距离
    private String distanceToIncisor;
    //胃周肿大淋巴结
    private String lymphAroundStomach;
    //HP 试验
    private String hp;
    //数据版本
    ...
    public String getDistanceToIncisor(){
        return distanceToIncisor;
    } 
    public void setDistanceToIncisor(String distanceToIncisor) {
         this.distanceToIncisor = distanceToIncisor;
    } 
    public String getLymphAroundStomach(){
        return lymphAroundStomach;
    } 
    public void setLymphAroundStomach(String lymphAroundStomach) {
         this.lymphAroundStomach = lymphAroundStomach;
    } 
    public String getHp(){
        return hp;
    } 
