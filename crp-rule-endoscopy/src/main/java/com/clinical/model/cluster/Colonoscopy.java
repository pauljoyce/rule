...
public class Colonoscopy{
    ...
    public String getDistanceToAnus(){
        return distanceToAnus;
    } 
    public void setDistanceToAnus(String distanceToAnus) {
         this.distanceToAnus = distanceToAnus;
    } 
