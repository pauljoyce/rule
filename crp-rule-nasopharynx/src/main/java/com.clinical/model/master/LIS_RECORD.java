...
public class LIS_RECORD{
    ...
    //标准化项目名称4
    private String TEST_ITEM_NAME4_STD;
    ...
    public String getTEST_ITEM_NAME4_STD(){
        return TEST_ITEM_NAME4_STD;
    } 
    public void setTEST_ITEM_NAME4_STD(String TEST_ITEM_NAME4_STD) {
         this.TEST_ITEM_NAME4_STD = TEST_ITEM_NAME4_STD;
    } 
}