...
public class DRUG_ORDER{
    ...
    private String MD5;
    //标准化药品名称
    private String ORDER_TEXT_STD;
    //标准化药品分类
    private String CLASSIFICATION_STD;
    ...
    public String getORDER_TEXT_STD(){
        return ORDER_TEXT_STD;
    } 
    public void setORDER_TEXT_STD(String ORDER_TEXT_STD) {
         this.ORDER_TEXT_STD = ORDER_TEXT_STD;
    } 
    public String getCLASSIFICATION_STD(){
        return CLASSIFICATION_STD;
    } 
    public void setCLASSIFICATION_STD(String CLASSIFICATION_STD) {
         this.CLASSIFICATION_STD = CLASSIFICATION_STD;
    } 
}