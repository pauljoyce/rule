...
public class EXAM_MASTER{
    ...
    //检查方式7
    private String EXAM_MODE7_STD;
    //身体部位7
    private String STRUCTURE7_STD;
    //标准名称7
    private String EXAM_NAME7_STD;
    //检查方式8
    private String EXAM_MODE8_STD;
    //身体部位8
    private String STRUCTURE8_STD;
    //标准名称8
    private String EXAM_NAME8_STD;
    //检查方式9
    private String EXAM_MODE9_STD;
    //身体部位9
    private String STRUCTURE9_STD;
    //标准名称9
    private String EXAM_NAME9_STD;
    ...
    public String getEXAM_MODE7_STD(){
        return EXAM_MODE7_STD;
    } 
    public void setEXAM_MODE7_STD(String EXAM_MODE7_STD) {
         this.EXAM_MODE7_STD = EXAM_MODE7_STD;
    } 
    ...
    public String getEXAM_NAME7_STD(){
        return EXAM_NAME7_STD;
    } 
    public void setEXAM_NAME7_STD(String EXAM_NAME7_STD) {
         this.EXAM_NAME7_STD = EXAM_NAME7_STD;
    } 
    public String getEXAM_MODE8_STD(){
        return EXAM_MODE8_STD;
    } 
    public void setEXAM_MODE8_STD(String EXAM_MODE8_STD) {
         this.EXAM_MODE8_STD = EXAM_MODE8_STD;
    } 
    ...
    public String getEXAM_NAME8_STD(){
        return EXAM_NAME8_STD;
    } 
    public void setEXAM_NAME8_STD(String EXAM_NAME8_STD) {
         this.EXAM_NAME8_STD = EXAM_NAME8_STD;
    } 
    public String getEXAM_MODE9_STD(){
        return EXAM_MODE9_STD;
    } 
    public void setEXAM_MODE9_STD(String EXAM_MODE9_STD) {
         this.EXAM_MODE9_STD = EXAM_MODE9_STD;
    } 
    ...
    public String getEXAM_NAME9_STD(){
        return EXAM_NAME9_STD;
    } 
    public void setEXAM_NAME9_STD(String EXAM_NAME9_STD) {
         this.EXAM_NAME9_STD = EXAM_NAME9_STD;
    } 
}