...
public class SMOKE_AND_DRINK{
    ...
    //饮酒类型
    private String drink_type_std;
    //饮酒量
    private String consumption_drink_std;
    //饮酒量单位
    private String consumption_drink_unit_std;
    //饮酒频次
    private String drink_freq_std;
    //饮酒频次单位
    private String drink_freq_unit_std;
    //是否戒酒标准名称
    ...
    public String getdrink_type_std(){
        return drink_type_std;
    } 
    public void setdrink_type_std(String drink_type_std) {
         this.drink_type_std = drink_type_std;
    } 
    public String getconsumption_drink_std(){
        return consumption_drink_std;
    } 
    public void setconsumption_drink_std(String consumption_drink_std) {
         this.consumption_drink_std = consumption_drink_std;
    } 
    public String getconsumption_drink_unit_std(){
        return consumption_drink_unit_std;
    } 
    public void setconsumption_drink_unit_std(String consumption_drink_unit_std) {
         this.consumption_drink_unit_std = consumption_drink_unit_std;
    } 
    public String getdrink_freq_std(){
        return drink_freq_std;
    } 
    public void setdrink_freq_std(String drink_freq_std) {
         this.drink_freq_std = drink_freq_std;
    } 
    public String getdrink_freq_unit_std(){
        return drink_freq_unit_std;
    } 
    public void setdrink_freq_unit_std(String drink_freq_unit_std) {
         this.drink_freq_unit_std = drink_freq_unit_std;
    } 
