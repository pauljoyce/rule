...
public class SPECIALITY_EXAM{
    ...
    //肌力
    private String force_entity;
    //肌张力
    private String tension_entity;
    //值
    ...
    private String md5;
    //肌力-标准名称
    private String force_entity_std;
    //值-标准名称
    ...
    //肌张力-标准名称
    private String tension_entity_std;
    ...
    public String getforce_entity(){
        return force_entity;
    } 
    public void setforce_entity(String force_entity) {
         this.force_entity = force_entity;
    } 
    public String gettension_entity(){
        return tension_entity;
    } 
    public void settension_entity(String tension_entity) {
         this.tension_entity = tension_entity;
    } 
    ...
    public String getforce_entity_std(){
        return force_entity_std;
    } 
    public void setforce_entity_std(String force_entity_std) {
         this.force_entity_std = force_entity_std;
    } 
    ...
    public String gettension_entity_std(){
        return tension_entity_std;
    } 
    public void settension_entity_std(String tension_entity_std) {
         this.tension_entity_std = tension_entity_std;
    } 
}