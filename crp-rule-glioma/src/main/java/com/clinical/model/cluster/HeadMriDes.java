...
public class HeadMriDes{
    ...
    public String getMassEffectStd(){
        return massEffectStd;
    } 
    public void setMassEffectStd(String massEffectStd) {
         this.massEffectStd = massEffectStd;
    } 
