...
public class Pathological{
    ...
    //病理组织类型
    private String pathologicalTypes;
    //WHO分级
    ...
    public String getPathologicalTypes(){
        return pathologicalTypes;
    } 
    public void setPathologicalTypes(String pathologicalTypes) {
         this.pathologicalTypes = pathologicalTypes;
    } 
    public String getWhoClassification(){
        return whoClassification;
    } 
    public void setWhoClassification(String whoClassification) {
