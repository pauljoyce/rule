...
public class ColonEsDes{
    ...
    //息肉距离肛门距离
    private String distanceStd;
    //息肉大小
    private String sizeStd;
    //息肉数量
    private String quantityStd;
    //是否行肠镜肿物切除
    private String treatmentStd;
    //数据版本
    ...
    public String getDistanceStd(){
        return distanceStd;
    } 
    public void setDistanceStd(String distanceStd) {
    ...
    public String getTreatmentStd(){
        return treatmentStd;
    } 
    public void setTreatmentStd(String treatmentStd) {
         this.treatmentStd = treatmentStd;
    } 
