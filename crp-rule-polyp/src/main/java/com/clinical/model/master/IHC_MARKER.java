...
public class IHC_MARKER{
    ...
    //具体检测结果标准名称id
    private String test_item_value_std;
    ...
    public String gettest_item_value_std(){
        return test_item_value_std;
    } 
    public void settest_item_value_std(String test_item_value_std) {
         this.test_item_value_std = test_item_value_std;
    } 
}