...
public class CLINICAL_DIAG{
    ...
    //分型分化标准名称id
    private String feature_std;
    //浸润标准名称id
    private String invasion_std;
    //否定词标准名称id
    ...
    public String getfeature_std(){
        return feature_std;
    } 
    public void setfeature_std(String feature_std) {
         this.feature_std = feature_std;
    } 
    public String getinvasion_std(){
        return invasion_std;
    } 
    public void setinvasion_std(String invasion_std) {
         this.invasion_std = invasion_std;
    } 
