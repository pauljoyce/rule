...
public class INP_CONSULTATION_DOCTOR_MASTER{
    //主键
    private Integer id;
    //唯一标识
    ...
    public String getconsult_note(){
        return consult_note;
    } 
    public void setconsult_note(String consult_note) {
         this.consult_note = consult_note;
    } 
