...
public class POSTOP_FUNCTION{
    ...
    //功能指标标准名称id
    private String function_para_std;
    //否定词标准名称id
    ...
    public String getfunction_para(){
        return function_para;
    } 
    public void setfunction_para(String function_para) {
         this.function_para = function_para;
    } 
    ...
    public String getfunction_para_std(){
        return function_para_std;
    } 
    public void setfunction_para_std(String function_para_std) {
         this.function_para_std = function_para_std;
    } 
