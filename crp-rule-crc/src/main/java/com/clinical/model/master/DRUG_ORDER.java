...
public class DRUG_ORDER{
    ...
    private String MD5;
    //标准化药物通用名
    private String GENERIC_STD;
    //标准化药物成分名
    private String INGREDIENT_STD;
    //药品分类
    private String pharmacologytype1;
    ...
    public String getGENERIC_STD(){
        return GENERIC_STD;
    }
    public void setGENERIC_STD(String GENERIC_STD) {
        this.GENERIC_STD = GENERIC_STD;
    }
    public String getINGREDIENT_STD(){
        return INGREDIENT_STD;
    }
    public void setINGREDIENT_STD(String INGREDIENT_STD) {
        this.INGREDIENT_STD = INGREDIENT_STD;
    }

    public String getPharmacologytype1() {
        return pharmacologytype1;
    }

    public void setPharmacologytype1(String pharmacologytype1) {
        this.pharmacologytype1 = pharmacologytype1;
    }
}