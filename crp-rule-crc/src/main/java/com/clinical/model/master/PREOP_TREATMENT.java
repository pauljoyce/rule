...
public class PREOP_TREATMENT{
    ...
    private String md5;
    //方案标准名称id
    private String regimen_std;
    //周期标准名称id
    private String course_std;
    //治疗标准名称id
    private String treatment_std;
    //部位标准名称id
    ...
    public String getregimen_std(){
        return regimen_std;
    } 
    public void setregimen_std(String regimen_std) {
         this.regimen_std = regimen_std;
    } 
    public String getcourse_std(){
        return course_std;
    } 
    public void setcourse_std(String course_std) {
         this.course_std = course_std;
    } 
    public String gettreatment_std(){
        return treatment_std;
    } 
    public void settreatment_std(String treatment_std) {
         this.treatment_std = treatment_std;
    } 
