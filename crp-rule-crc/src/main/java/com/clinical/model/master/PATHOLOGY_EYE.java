...
public class PATHOLOGY_EYE{
    ...
    //切缘距离标准名称id
    private String edge_distance_std;
    ...
    public String getedge_distance_std(){
        return edge_distance_std;
    } 
    public void setedge_distance_std(String edge_distance_std) {
         this.edge_distance_std = edge_distance_std;
    } 
}