...
public class PrimaryDiagnosis{
    ...
    //诊断名称
    private String diagnosisNameIcd;
    //诊断类型
    ...
    public String getDiagnosisNameIcd(){
        return diagnosisNameIcd;
    } 
    public void setDiagnosisNameIcd(String diagnosisNameIcd) {
         this.diagnosisNameIcd = diagnosisNameIcd;
    } 
