...
public class StemCells{
    ...
    //干细胞回输时间
    private Date stemTime;
    //干细胞移植
    private String stemTreatment;
    //干细胞回输数量
    ...
    public void setStemTime(Date stemTime) {
         this.stemTime = stemTime;
    } 
    public String getStemTreatment(){
        return stemTreatment;
    } 
    public void setStemTreatment(String stemTreatment) {
         this.stemTreatment = stemTreatment;
    } 
