...
public class HisPast{
    ...
    //放射性物质接触史
    private String exposureRadioactive;
    //毒性物质接触史（木尘；苯；亚硝酸氧化物）
    private String exposureToxic;
    //数据版本
    ...
    public String getExposureRadioactive(){
        return exposureRadioactive;
    } 
    public void setExposureRadioactive(String exposureRadioactive) {
         this.exposureRadioactive = exposureRadioactive;
    } 
    public String getExposureToxic(){
        return exposureToxic;
    } 
    public void setExposureToxic(String exposureToxic) {
         this.exposureToxic = exposureToxic;
    } 
