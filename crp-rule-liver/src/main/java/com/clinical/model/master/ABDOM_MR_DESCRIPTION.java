...
public class ABDOM_MR_DESCRIPTION{
    //顺序流水号
    ...
    //病灶-T1
    private String lesion_t1_std;
    //病灶-T2
    private String lesion_t2_std;
    //病灶-T1(信号）
    private String lesion_t1_strength_std;
    //病灶-T2(信号）
    private String lesion_t2_strength_std;
    //大小-最大径1
    private Double size_max_diam1_std;
    //大小-第二径1
    private Double size_second_diam1_std;
    //大小-第三径1
    private Double size_third_diam1_std;
    //大小-最小径1
    ...
    public String getlesion_t1_std(){
        return lesion_t1_std;
    } 
    public void setlesion_t1_std(String lesion_t1_std) {
         if("无效".equals(lesion_t1_std)){
             this.lesion_t1_std =""; 
         }else{
             this.lesion_t1_std = lesion_t1_std;
         }
    } 
    public String getlesion_t2_std(){
        return lesion_t2_std;
    } 
    public void setlesion_t2_std(String lesion_t2_std) {
         if("无效".equals(lesion_t2_std)){
             this.lesion_t2_std =""; 
         }else{
             this.lesion_t2_std = lesion_t2_std;
         }
    } 
    public String getlesion_t1_strength_std(){
        return lesion_t1_strength_std;
    } 
    public void setlesion_t1_strength_std(String lesion_t1_strength_std) {
         if("无效".equals(lesion_t1_strength_std)){
             this.lesion_t1_strength_std =""; 
         }else{
             this.lesion_t1_strength_std = lesion_t1_strength_std;
         }
    } 
    public String getlesion_t2_strength_std(){
        return lesion_t2_strength_std;
    } 
    public void setlesion_t2_strength_std(String lesion_t2_strength_std) {
         if("无效".equals(lesion_t2_strength_std)){
             this.lesion_t2_strength_std =""; 
         }else{
             this.lesion_t2_strength_std = lesion_t2_strength_std;
         }
    } 
    ...
    public Double getsize_second_diam1_std(){
        return size_second_diam1_std;
    } 
    public void setsize_second_diam1_std(Double size_second_diam1_std) {
             this.size_second_diam1_std = size_second_diam1_std;
    } 
    public Double getsize_third_diam1_std(){
        return size_third_diam1_std;
    } 
    public void setsize_third_diam1_std(Double size_third_diam1_std) {
             this.size_third_diam1_std = size_third_diam1_std;
    } 
