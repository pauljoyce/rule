...
public class ABDOM_CT_ENTRY_RESULTS{
    //顺序流水号
    ...
    //部位-标准部位8
    private String structure_site8_std;
    //部位-标准名称9
    private String structure9_std;
    //部位-标准部位9
    private String structure_site9_std;
    //病变-标准影像1
    ...
    //病变-性质
    private String lesion_nature_std;
    //特别动作-标准名称
    ...
    //性质数量-标准名称
    private String nature_quantity_std;
    ...
    public void setstructure8_std(String structure8_std) {
         if("无效".equals(structure8_std)){
             this.structure8_std =""; 
         }else{
             this.structure8_std = structure8_std;
         }
    } 
    public String getstructure_site8_std(){
        return structure_site8_std;
    } 
    public void setstructure_site8_std(String structure_site8_std) {
         if("无效".equals(structure_site8_std)){
             this.structure_site8_std =""; 
         }else{
             this.structure_site8_std = structure_site8_std;
         }
    } 
    public String getstructure9_std(){
        return structure9_std;
    } 
    public void setstructure9_std(String structure9_std) {
         if("无效".equals(structure9_std)){
             this.structure9_std =""; 
         }else{
             this.structure9_std = structure9_std;
         }
    } 
    public String getstructure_site9_std(){
        return structure_site9_std;
    } 
    public void setstructure_site9_std(String structure_site9_std) {
         if("无效".equals(structure_site9_std)){
             this.structure_site9_std =""; 
         }else{
             this.structure_site9_std = structure_site9_std;
         }
    } 
    ...
    public String getlesion_nature_std(){
        return lesion_nature_std;
    } 
    public void setlesion_nature_std(String lesion_nature_std) {
         if("无效".equals(lesion_nature_std)){
             this.lesion_nature_std =""; 
         }else{
             this.lesion_nature_std = lesion_nature_std;
         }
    } 
    ...
    public String getnature3_std(){
        return nature3_std;
    } 
    public void setnature3_std(String nature3_std) {
         if("无效".equals(nature3_std)){
             this.nature3_std =""; 
         }else{
             this.nature3_std = nature3_std;
         }
    } 
    ...
    public String getnature_quantity_std(){
        return nature_quantity_std;
    } 
    public void setnature_quantity_std(String nature_quantity_std) {
         if("无效".equals(nature_quantity_std)){
             this.nature_quantity_std =""; 
         }else{
             this.nature_quantity_std = nature_quantity_std;
         }
    } 
}