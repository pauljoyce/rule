...
public class TEM_COURSE_DIS{
    ...
    //病程主题（病程记录_日常病程）
    private String medical_topic;
    //住院病程（病程记录_日常病程）
    private String inpatient_disease_process;
    //诊断依据（病程记录_日常病程）
    ...
    public String getmedical_topic(){
        return medical_topic;
    } 
    public void setmedical_topic(String medical_topic) {
             this.medical_topic = medical_topic;
    } 
    public String getinpatient_disease_process(){
        return inpatient_disease_process;
    } 
    public void setinpatient_disease_process(String inpatient_disease_process) {
             this.inpatient_disease_process = inpatient_disease_process;
    } 
