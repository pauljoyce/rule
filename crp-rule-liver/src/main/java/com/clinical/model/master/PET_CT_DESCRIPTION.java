...
public class PET_CT_DESCRIPTION{
    //顺序流水号
    ...
    //浓聚-标准名称
    private String concentration_std;
    //大小-最大径
    private Double size_max_diam_std;
    //大小-中间径
    private Double size_median_diam_std;
    //大小-最小径
    private Double size_min_diam_std;
    //大小-单位
    private String size_unit_std;
    ...
    public String getconcentration_std(){
        return concentration_std;
    } 
    public void setconcentration_std(String concentration_std) {
         if("无效".equals(concentration_std)){
             this.concentration_std =""; 
         }else{
             this.concentration_std = concentration_std;
         }
    } 
    public Double getsize_max_diam_std(){
        return size_max_diam_std;
    } 
    public void setsize_max_diam_std(Double size_max_diam_std) {
             this.size_max_diam_std = size_max_diam_std;
    } 
    public Double getsize_median_diam_std(){
        return size_median_diam_std;
    } 
    public void setsize_median_diam_std(Double size_median_diam_std) {
             this.size_median_diam_std = size_median_diam_std;
    } 
    public Double getsize_min_diam_std(){
        return size_min_diam_std;
    } 
    public void setsize_min_diam_std(Double size_min_diam_std) {
             this.size_min_diam_std = size_min_diam_std;
    } 
    public String getsize_unit_std(){
        return size_unit_std;
    } 
    public void setsize_unit_std(String size_unit_std) {
         if("无效".equals(size_unit_std)){
             this.size_unit_std =""; 
         }else{
             this.size_unit_std = size_unit_std;
         }
    } 
}