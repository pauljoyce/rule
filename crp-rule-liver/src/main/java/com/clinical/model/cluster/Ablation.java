...
public class Ablation{
    ...
    //肝动脉介入治疗方式
    private String therapyMethods;
    //肝动脉介入治疗栓塞剂（可多种栓塞剂）
    private String embolic;
    //肝动脉介入治疗化疗药物（可多种化疗药物）
    private String drug;
    //介入治疗肝肿瘤部位
    private String site;
    ...
    public String getTherapyMethods(){
        return therapyMethods;
    } 
    public void setTherapyMethods(String therapyMethods) {
         this.therapyMethods = therapyMethods;
    } 
    public String getEmbolic(){
        return embolic;
    } 
    public void setEmbolic(String embolic) {
         this.embolic = embolic;
    } 
